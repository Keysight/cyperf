...
def binary_search_for_optimal_throughput( results_folder, test_name, config_path,perform_validation,number_of_streams,number_of_trials_in_binary_search,Initiator_mgmt_ip,responder_mgmt_ip,initial_target_throughput_in_gbps,max_allowable_througput_in_gbps,initial_minimum_throughput_limit_in_gbps,tolerance ):
    ...
    print('*******soumya : I am inside Binary search******* ')
    print('**************The value of target throughput now is {} gbps with tolerance of {} ************'.format(initial_target_throughput_in_gbps,tolerance))
    print('************************************************************************************************************')
    ...
    while (1):
                    while( target_throughput_acheived ):
                        ...
                        print('****** upper half validations ************')
                        print('***** previous throughput **** {}'.format(previous_run_throughput_in_gbps))
                        ...
                        print('***** present throughput **** {}'.format(initial_target_throughput_in_gbps))
                        print("********** new throughput for this trial = {} ***********************".format(initial_target_throughput_in_gbps))
                        ...
                        print ('********* packet rate {}********',format(packet_rate))
                        rest.set_udp_stream_packet_rate(packet_rate)
                        ...
                        if(target_throughput_acheived):
                            ...
                            print("*********************Test run start*********************************")
                            print("The frame per second for this run = {}".format(packet_rate))
                            print("The present attempted throughput in Gbps is {}. This was acheived considering the tolerance level ".format(present_run_throughput_in_gbps))
                    ...
                    while( not target_throughput_acheived ):
                        ...
                        if(target_throughput_acheived):
                            ...
                            print("*********************Test run start*********************************")
                            print("The frame per second for this run = {} ".format(packet_rate))
                            print("The present attempted throughput in Gbps is {} . This was achieved considering tolearnce level".format(present_run_throughput_in_gbps))
                            print("The previous attempted throughput in Gbps was {} ".format(previous_run_throughput_in_gbps))
                            print("********************************************************************")
                            max_allowable_througput_in_gbps = previous_run_throughput_in_gbps

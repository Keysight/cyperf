...
def binary_search_for_optimal_throughput( results_folder, test_name, config_path,perform_validation,number_of_streams,Initiator_mgmt_ip,responder_mgmt_ip,initial_target_throughput_in_gbps,initial_minimum_throughput_limit_in_gbps,tolerance ):
    
    #now start the binary algoritm to search the best Throughput 
    print("*******soumya : I am inside Binary search******* ")
    print("**************The value of target throughput now is {} gbps************".format(initial_target_throughput_in_gbps))
    ...
    stop_trial_for_frame_size=collect_stats_validate_throughput( results_folder, test_name, config_path,perform_validation,number_of_streams,Initiator_mgmt_ip,responder_mgmt_ip,initial_target_throughput_in_Bps,tolerance)
    ...
    while( not stop_trial_for_frame_size ):
        ...
        initial_target_throughput_in_gbps=(previous_run_throughput_in_gbps - initial_minimum_throughput_limit_in_gbps)/2
        print("***************Soumya********** new throughput for this trial = {}".format(initial_target_throughput_in_gbps))
        ...
        run_test()
        stop_trial_for_frame_size=collect_stats_validate_throughput("../test_results", "RFC-2544-udp-streaming-throughput","./RFC-2544-throughput",False,number_of_streams,Initiator_mgmt_ip,responder_mgmt_ip,present_target_throughput_in_Bps,tolerance)
...
#check the values enetred by the user 

if (initial_target_throughput_in_gbps <initial_minimum_throughput_limit_in_gbps) :
   raise Exception("initial_target_throughput_in_gbps <initial_minimum_throughput_limit_in_gbps")
if (initial_minimum_throughput_limit_in_gbps < 0) :
   raise Exception("initial_minimum_throughput_limit_in_gbps < 0 is not acceptable ")
...
if(initial_minimum_throughput_limit_in_gbps > 0):
    ...
    run_test()
    stop_trial_for_frame_size=collect_stats_validate_throughput("../test_results", "RFC-2544-udp-streaming-throughput","./RFC-2544-throughput",False,number_of_streams,Initiator_mgmt_ip,responder_mgmt_ip,min_target_throughput_in_Bps,tolerance)
    if( not stop_trial_for_frame_size):
        ...
        binary_search_for_optimal_throughput("../test_results", "RFC-2544-udp-streaming-throughput","./RFC-2544-throughput",False,number_of_streams,Initiator_mgmt_ip,responder_mgmt_ip,initial_target_throughput_in_gbps ,initial_minimum_throughput_limit_in_gbps ,tolerance)

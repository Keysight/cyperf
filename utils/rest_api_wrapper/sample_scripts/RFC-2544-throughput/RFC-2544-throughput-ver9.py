...
def binary_search_for_optimal_throughput( results_folder, test_name, config_path,perform_validation,number_of_streams,number_of_trials_in_binary_search,Initiator_mgmt_ip,responder_mgmt_ip,initial_target_throughput_in_gbps,max_allowable_througput_in_gbps,minimum_throughput_limit_in_gbps,tolerance ):
    ...
    while (1):
                    while( target_throughput_acheived ):
                        ...
                        print(f"minumum  throughput = {minimum_throughput_limit_in_gbps} gbps".ljust(width))
                        print(f"maximum throughput  = {max_allowable_througput_in_gbps} gbps".ljust(width))
                        ...
                        print(f"target throughput = {initial_target_throughput_in_gbps} gbps".ljust(width))
                    ...
                    while( not target_throughput_acheived ):
                        ...
                        print(f"maximum allowable throughput =  {max_allowable_througput_in_gbps} gbps ".center(width))
                        print(f"minimum throughput limit  =  {minimum_throughput_limit_in_gbps} gbps ".center(width))
                        ...
                        print(f"New target throughput for this trial = {initial_target_throughput_in_gbps} gbps".ljust(width))

...
```
# azcopy copy
"https://cyperf.blob.core.windows.net/keysight-cyperf-4-0/<Keysight SAS-token>"  "https://<User’s storage name where file need to be copied>.blob.core.windows.net/< User’s container name>/<SAS-token>" 
"https://cyperf.blob.core.windows.net/keysight-cyperf-4-0/<Keysight SAS-token>"  "https://<User’s storage name where file need to be copied>.blob.core.windows.net/< User’s container name>/<SAS-token>" 
--recursive=true

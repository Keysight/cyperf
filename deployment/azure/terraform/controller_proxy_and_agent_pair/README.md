...
| broker_name   | keysight-cyperf-controller-proxy-4-0      | Name for the cyperf broker machines. |
| agent_name   | keysight-cyperf-agent-4-0            | Name for the cyperf agent machines. |

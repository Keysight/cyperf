...
| broker_name   | keysight-cyperf-controller-proxy-26-0-0      | Name for the cyperf broker machines. |
| agent_name   | keysight-cyperf-agent-26-0-0            | Name for the cyperf agent machines. |

...
| broker_name   | keysight-cyperf-controller-proxy-2-5      | Name for the cyperf broker machines. |
| agent_name   | keysight-cyperf-agent-2-5            | Name for the cyperf agent machines. |

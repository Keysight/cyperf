...
| broker_name   | keysight-cyperf-controller-proxy-5-0      | Name for the cyperf broker machines. |
| agent_name   | keysight-cyperf-agent-5-0            | Name for the cyperf agent machines. |

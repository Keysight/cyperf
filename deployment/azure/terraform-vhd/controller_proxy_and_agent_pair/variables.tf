...
variable "controller_proxy_image" {
  type        = string
  default     = "https://cyperf.blob.core.windows.net/keysight-cyperf-7-0/keysight-cyperf-controller-proxy-7-0.vhd"
  description = "Controller proxy image path"
}

variable "agent_image" {
  type        = string
  default     = "https://cyperf.blob.core.windows.net/keysight-cyperf-7-0/keysight-cyperf-agent-7-0.vhd"

...
| controllerSourceImage                   | keysight-cyperf-controller-7-0            | Preferred CyPerf Controller image.  |
| agentSourceImage                   | keysight-cyperf-agent-7-0            | Preferred CyPerf Agent image.  |

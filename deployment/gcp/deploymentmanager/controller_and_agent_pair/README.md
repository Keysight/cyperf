...
| controllerSourceImage                   | keysight-cyperf-controller-5-0            | Preferred CyPerf Controller image.  |
| agentSourceImage                   | keysight-cyperf-agent-5-0            | Preferred CyPerf Agent image.  |

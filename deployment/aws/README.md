...
The following AMIs are available for CyPerf 1.0 release.

-	keysight-cyperf-controller-1-0 

-	keysight-cyperf-controller-proxy-1-0

-	keysight-cyperf-agent-1-0
...
2.	Go to **Community AMIs** and select **“keysight-cyperf-controller-1-0”**. 
...
1.	In the AWS console, select **EC2** service, followed by **Instances** and **Launch Instance**.
2.	Go to **Community AMIs** and search and select **“keysight-cyperf-agent-1-0”**. 

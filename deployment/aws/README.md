...
The following AMIs are available for CyPerf 4.0 release.

-	keysight-cyperf-controller-4-0

-	keysight-cyperf-controller-proxy-4-0

-	keysight-cyperf-agent-4-0
...
2.	Go to **Community AMIs** and select **“keysight-cyperf-controller-4-0”**. 
...
1.	In the AWS console, select **EC2** service, followed by **Instances** and **Launch Instance**.
2.	Go to **Community AMIs** and then select **“keysight-cyperf-controller-proxy-4-0”**. 
...
1.	In the AWS console, select **EC2** service, followed by **Instances** and **Launch Instance**.
2.	Go to **Community AMIs** and search and select **“keysight-cyperf-agent-4-0”**. 
